...
console.log("[Dreamcord] Starting up...");
...
if (!IS_VANILLA) {
    ...
    if (!IS_VESKTOP && !IS_EQUIBOP) {
        try {
            ...
            console.error("[Dreamcord] Failed to install host update hook", err);
        }
    }
    ...
    process.env.DATA_DIR = join(app.getPath("userData"), "..", "Dreamcord");
    ...
    console.log("[Dreamcord] Running in vanilla mode. Not loading Dreamcord");
}

console.log("[Dreamcord] Loading original Discord app.asar");
