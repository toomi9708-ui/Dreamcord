...
export default definePlugin({
    ...
    toolboxActions: {
        "Open Icons Tab"() {
            SettingsRouter.openUserSettings("dreamcord_icon_viewer_panel");
        },
    },
    settingsAboutComponent: SettingsAbout,
    start() {
        SettingsPlugin.customEntries.push({
            key: "dreamcord_icon_viewer",
            title: "Icon Finder",
            Component: IconsTab,
    ...
    stop() {
        removeFromArray(SettingsPlugin.customEntries, e => e.key === "dreamcord_icon_viewer");
    },
});
