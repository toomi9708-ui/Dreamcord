...
const settings = definePluginSettings({
    showDreamcordDonor: {
        ...
        description: "Enable to show Dreamcord Donor badges in chat.",
        hidden: true,
        default: true
    },
    DreamcordDonorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the Dreamcord Donor badges.",
        hidden: true,
        default: 0
    },
    showDreamcordContributor: {
        type: OptionType.BOOLEAN,
        description: "Enable to show Dreamcord Contributor badges in chat.",
        hidden: true,
        default: true
    },
    DreamcordContributorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the Dreamcord Contributor badge.",
        hidden: true,
        default: 1
    },
    showVencordDonor: {
...
const BadgeSettings = () => {
    const [images, setImages] = useState([
        { src: "https://badge.dreamcord.org/donor.webp", shown: settings.store.showDreamcordDonor, title: "Dreamcord donor badges", key: "DreamcordDonor", position: settings.store.DreamcordDonorPosition },
        { src: "https://dreamcord.org/assets/favicon.png", shown: settings.store.showDreamcordContributor, title: "Dreamcord contributor badge", key: "DreamcordContributer", position: settings.store.DreamcordContributorPosition },
    ...
    useEffect(() => {
        images.forEach(image => {
            switch (image.key) {
                case "DreamcordDonor":
                    settings.store.DreamcordDonorPosition = image.position;
                    settings.store.showDreamcordDonor = image.shown;
                    break;
                case "DreamcordContributer":
                    settings.store.DreamcordContributorPosition = image.position;
                    settings.store.showDreamcordContributor = image.shown;
                    break;
                case "VencordDonor":
