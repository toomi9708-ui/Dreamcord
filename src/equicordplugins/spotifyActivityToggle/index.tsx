...
import dreamcordToolbox from "@dreamcordplugins/dreamcordToolbox";
...
function SpotifyActivityToggleButton({ iconForeground, hideTooltips, nameplate }: UserAreaRenderProps) {
    ...
    if (!isLoaded || !spotifyId || location !== "PANEL" && isPluginEnabled(dreamcordToolbox.name)) return null;
...
const settings = definePluginSettings({
    location: {
        ...
        options: [
            ...
            { label: "Dreamcord Toolbox", value: "TOOLBOX" }
        ],
        get hidden() {
            return !isPluginEnabled(dreamcordToolbox.name);
        }
    },
});
