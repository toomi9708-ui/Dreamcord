...
export const settings = definePluginSettings({
    format: {
        ...
        default: "{dreamcordIcon} Dreamcord {dreamcordVersion} ({dreamcordHash})",
        restartNeeded: true
    }
});
...
export const settingVariables = [
    ...
    "",
    "Dreamcord Variables:",
    "{dreamcordIcon} - Dreamcord icon",
    "{dreamcordVersion} - Version of Dreamcord (e.g. 1.0.0)",
    "{dreamcordHash} - Dreamcord build hash (e.g. 123456789)",
    "{dreamcordPlatform} - Platform Dreamcord is running on (e.g. Dev Build)",
    "",
