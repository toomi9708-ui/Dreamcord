...
export function FormatSetting(setValue) {
    ...
    const [state, setState] = useState(format ?? "{buildChannel} {buildNumber} ({buildHash}) | {dreamcordName} {dreamcordVersion} ({dreamcordHash})");
    ...
    return (
        <section>
            ...
            <textarea
                ...
                placeholder="{buildChannel} {buildNumber} ({buildHash}) | {dreamcordName} {dreamcordVersion} ({dreamcordHash})"
                rows={1}
                ref={el => {
                    if (el) {
