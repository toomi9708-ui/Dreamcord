...
export default definePlugin({
    ...
    authors: [Devs.Ven, Devs.Nyako, DreamcordDevs.Loukios, DreamcordDevs.examplegit, DreamcordDevs.qdnx],
    settings,
    contextMenus: {
    ...
    settingsAboutComponent({ tempSettings: s }: { tempSettings?: any; }) {
        ...
        const authorUser = UserStore.getUser(String(DreamcordDevs.examplegit.id));
