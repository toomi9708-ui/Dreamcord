...
import { LyricsData, Provider } from "@dreamcordplugins/musicControls/spotify/lyrics/providers/types";
...
export async function getLyricsLrclib(track: Track): Promise<LyricsData | null> {
    ...
    const response = await fetch(url, {
        headers: {
            "User-Agent": "SpotifyLyrics for Dreamcord (https://github.com/Masterjoona/vc-spotifylyrics)"
        }
    });
