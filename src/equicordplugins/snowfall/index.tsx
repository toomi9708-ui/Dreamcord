...
export default definePlugin({
    ...
    tags: ["Appearance"],
    authors: [DreamcordDevs.ZcraftElite, DreamcordDevs.square],
    ...
    settingsAboutComponent: () => (
        <>
            ...
            <Paragraph>
                ...
                <br /><br />
                NOTE: While on most computers this plugin will not impact performance any more than your average Dreamcord extension,
