...
const NOTIFICATION_AUDIO_URL = "https://raw.githubusercontent.com/Dreamcord/Equibored/main/sounds/waitForSlot/notification.mp3";
...
export default definePlugin({
    ...
    authors: [DreamcordDevs.omaw, Devs.prism],
    settings,
    patches: [
        {
