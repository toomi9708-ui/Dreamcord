...
import { Devs, DreamcordDevs, SUPPORT_CHANNEL_IDS } from "@utils/constants";
...
const TEXT_REPLACE_RULES_EXEMPT_CHANNEL_IDS = [
    ...
    "1419347113745059961", // Dreamcord's Requests Channel
    ...SUPPORT_CHANNEL_IDS
];
...
export default definePlugin({
    ...
    authors: [Devs.AutumnVN, Devs.TheKodeToad, DreamcordDevs.Etorix, DreamcordDevs.Ape],
    isModified: true,
    settings,
