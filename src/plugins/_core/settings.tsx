...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the Dreamcord settings section",
        options: [
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        if (layout.some(s => s?.key === "dreamcord_section")) return layout;

        const { buildEntry } = this;

        const dreamcordEntries: SettingsLayoutNode[] = [
            buildEntry({
                key: "dreamcord_main",
                title: "Dreamcord",
                panelTitle: "Dreamcord Settings",
                Component: VencordTab,
                Icon: MainSettingsIcon
            }),
            buildEntry({
                key: "dreamcord_plugins",
                title: "Plugins",
                Component: PluginsTab,
                Icon: PluginsIcon
            }),
            buildEntry({
                key: "dreamcord_themes",
                title: "Themes",
                Component: ThemesTab,
                Icon: PaintbrushIcon
            }),
            !IS_UPDATER_DISABLED && UpdaterTab && buildEntry({
                key: "dreamcord_updater",
                title: "Updater",
                panelTitle: "Dreamcord Updater",
                Component: UpdaterTab,
                Icon: UpdaterIcon
            }),
            buildEntry({
                key: "dreamcord_changelog",
                title: "Changelog",
            ...
            buildEntry({
                key: "dreamcord_cloud",
                title: "Cloud",
                panelTitle: "Dreamcord Cloud",
                Component: CloudTab,
                Icon: CloudIcon
            }),
            buildEntry({
                key: "dreamcord_backup_restore",
                title: "Backup & Restore",
                Component: BackupAndRestoreTab,
                Icon: BackupRestoreIcon
            }),
            !IS_STANDALONE && PatchHelperTab && buildEntry({
                key: "dreamcord_patch_helper",
                title: "Patch Helper",
        ...
        const dreamcordSection: SettingsLayoutNode = {
            key: "dreamcord_section",
            type: LayoutTypes.SECTION,
            useTitle: () => "Dreamcord Settings",
            buildLayout: () => dreamcordEntries
        };
        ...
        layout.splice(idx, 0, dreamcordSection);
    ...
    getInfoRows() {
        ...
        const rows = [`Dreamcord ${gitHashShort}${getVersionInfo()}`];
