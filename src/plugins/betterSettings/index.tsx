...
import { AchievementsIcon, AppsIcon, CreditCardIcon, DreamcordIcon, GameControllerIcon, HammerAndChiselIcon, MainSettingsIcon, PencilSparkleIcon, UserIcon } from "@components/Icons";
import { buildPluginMenuEntries, buildThemeMenuEntries } from "@dreamcordplugins/dreamcordToolbox/menu";
...
const SECTION_ICONS: Record<string, Icon> = {
    ...
    dreamcord_section: DreamcordIcon,
...
export default definePlugin({
    ...
    transformSettingsEntries(list) {
        ...
        for (const item of flat) {
            ...
            if (key === "dreamcord_plugins" || key === "dreamcord_themes") {
                const children = key === "dreamcord_plugins"
