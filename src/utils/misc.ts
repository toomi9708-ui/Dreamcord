...
import { EQUICORD_HELPERS, DreamcordDevsById, GUILD_ID, KNOWN_ISSUES_CHANNEL_ID, SUPPORT_CHANNEL_ID, VencordDevsById } from "./constants";
...
export const isDreamcordPluginDev = (id: string) => Object.hasOwn(DreamcordDevsById, id);
export const shouldShowDreamcordContributorBadge = (id: string) => isDreamcordPluginDev(id) && DreamcordDevsById[id].badge !== false;

export const isAnyPluginDev = (id: string) => Object.hasOwn(VencordDevsById, id) || Object.hasOwn(DreamcordDevsById, id);
...
export function isDreamcordGuild(id: string | null | undefined, isGuildId: boolean = false): boolean {
    if (!id) return false;
...
export function isDreamcordSupport(userId: string | null | undefined): boolean {
