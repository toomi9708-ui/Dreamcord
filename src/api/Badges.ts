...
import globalBadges from "@dreamcordplugins/globalBadges";
...
export function _getBadges(args: BadgeUserArgs) {
    ...
    const dreamcordDonorBadges = BadgeAPIPlugin.getDreamcordDonorBadges(args.userId);
    ...
    if (dreamcordDonorBadges) {
        badges.unshift(
            ...dreamcordDonorBadges.map(badge => ({
                ...args,
                ...badge,
            }))
        );
