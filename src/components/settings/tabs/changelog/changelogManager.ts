...
const CHANGELOG_HISTORY_KEY = "DreamcordChangelog_History";
const LAST_SEEN_HASH_KEY = "DreamcordChangelog_LastSeenHash";
const KNOWN_PLUGINS_KEY = "DreamcordChangelog_KnownPlugins";
const KNOWN_SETTINGS_KEY = "DreamcordChangelog_KnownSettings";
const LAST_REPO_CHECK_KEY = "DreamcordChangelog_LastRepoCheck";
