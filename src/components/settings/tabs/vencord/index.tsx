...
const SHIGGY_DONATE_IMAGE = "https://dreamcord.org/assets/favicon.png";
...
function DreamcordSettings() {
    ...
    return (
        <SettingsTab>
            {(isDreamcordDonor(user?.id) || isVencordDonor(user?.id)) ? (
                <SpecialCard
                    title="Donations"
                    subtitle="Thank you for donating!"
                    description={
                        isDreamcordDonor(user?.id) && isVencordDonor(user?.id)
                            ? "All Vencord users can see your Vencord donor badge, and Dreamcord users can see your Dreamcord donor badge. To change your Vencord donor badge, contact @vending.machine. For your Dreamcord donor badge, make a ticket in Dreamcord's server."
                            : isVencordDonor(user?.id)
                                ? "All Vencord users can see your badge! You can manage your perks by messaging @vending.machine."
                                : "All Dreamcord users can see your badge! You can manage your perks by making a ticket in Dreamcord's server."
                    }
                ...
                <SpecialCard
                    ...
                    description="Please consider supporting the development of Dreamcord by donating!"
            ...
            {isAnyPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to Dreamcord you now have a cool new badge!"
            ...
            <Paragraph className={Margins.bottom16}>
                Configure how Dreamcord behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.
            </Paragraph>
...
export default wrapTab(DreamcordSettings, "Dreamcord Settings");

export function isDreamcordDonor(userId: string): boolean {
    const donorBadges = BadgeAPI.getDreamcordDonorBadges(userId);
