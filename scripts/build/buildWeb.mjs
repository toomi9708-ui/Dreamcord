...
const buildConfigs = [
    ...
    },
    {
        ...
        outfile: "dist/Dreamcord.user.js",
        banner: {
...
async function buildExtension(target, files) {
    const entries = {
        "dist/Dreamcord.js": await readFile("dist/browser/extension.js"),
        "dist/Dreamcord.css": await readFile("dist/browser/extension.css"),
...
const appendCssRuntime = readFile("dist/Dreamcord.user.css", "utf-8").then(content => {
    const cssRuntime = `unsafeWindow._vcUserScriptRendererCss=\`${content.replaceAll("`", "\\`")}\``;

    return appendFile("dist/Dreamcord.user.js", cssRuntime);
});
